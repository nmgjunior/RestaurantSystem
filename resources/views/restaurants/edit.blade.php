    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Editar Restaurante</h2>
                    <form action="/restaurant/update/{{$restaurant->id}}" method="POST">
                        <div class="row row-space">
                            <div class="col-2">
                                ...
                                <input class="input--style-4" type="text" name="name" value="{{$restaurant->name}}">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Código</label>
                                    <input class="input--style-4" type="text" name="code" value="{{$restaurant->code}}">
                                </div>
                            </div>
                        </div>
                        <div class="p-t-15">
