						...
						<table>
							<thead>
								<tr class="row100 head">
                                    ...
                                    <th class="cell100 column2">Produto</th>
                                    <th class="cell100 column3">Preço</th>
					...
					<div class="table100-body js-pscroll">
						<table>
							<tbody>
                                ...
                                <td class="cell100 column1">{{$product->code}}</td>
                                    <td class="cell100 column2">{{$product->name}}</td>
                                    ...
                                    <td class="cell100 column5">
                                        <a class="btn btn-danger" href="/product/destroy/{{$product->id}}" method="POST" role="button">Apagar</a>
                                    </td>
